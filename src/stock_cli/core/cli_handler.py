...
class CLICommandHandler:
    ...
    def show_help(self, version: str):
        """显示帮助信息"""
        help_text = f"""
[bold blue]Stock Agent CLI v{version} - 帮助[/bold blue]
...
"""
    ...
    def show_status(self, model: str):
        """显示系统状态"""
        try:
...
"""
    ...
    def format_reasoning(self, lines: List[str]) -> List[str]:
        """格式化推理步骤"""
        out: List[str] = []
        for ln in lines:
    ...
    def print_banner(self, model: str, mode: str):
        """打印横幅"""
        # 仅在 verbose 模式调用
